...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FF6B6B,50:C84B31,100:6C63FF&height=200&section=header&text=Hamza%20Erhan&fontSize=70&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=AI%2FML%20Engineer%20%7C%20Agent%20Systems%20%7C%20Data%20Science&descAlignY=60&descAlign=50" width="100%"/>
...
developer = {
    "name":       "Hamza Erhan",
    "role":       "AI/ML Engineer (new grad)",
    "languages":  ["Python", "C#", "Dart", "Ruby", "JavaScript", "SQL"],
    "frameworks": ["PyTorch", "scikit-learn", "Flutter", ".NET", "Ruby on Rails"],
    "databases":  ["MySQL", "PostgreSQL", "SQLite"],
    "focus":      ["Machine Learning", "AI Agent Systems", "Data Science"],
    "currently":  "Building autonomous agent systems & shipping ML projects 🔬",
